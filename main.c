...
static can_alt_arm_state_t alt_1_arm_state = ALT_ARM_STATE_ARMED;
static can_alt_arm_state_t alt_2_arm_state = ALT_ARM_STATE_ARMED;
...
int main(int argc, char **argv) {
    ...
    while (1) {
        ...
        if (alt_1_arm_state == ALT_ARM_STATE_DISARMED) {
            DISARM_A1();
            RED_LED_OFF();
        } else {
            ARM_A1();
        ...
        if (alt_2_arm_state == ALT_ARM_STATE_DISARMED) {
            DISARM_A2();
            BLUE_LED_OFF();
        } else {
            ARM_A2();
    ...
    switch (msg_type) {
        case MSG_ALT_ARM_CMD:
            ...
            if (alt_id == ALTIMETER_RAVEN) {
                alt_1_arm_state = desired_arm_state;
            }
            if (alt_id == ALTIMETER_STRATOLOGGER) {
                alt_2_arm_state = desired_arm_state;
            }
            break;
